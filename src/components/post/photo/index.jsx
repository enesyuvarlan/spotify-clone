export default function Photo({photos}) {
  switch (photos.length) {
    ...
    case 2:
      return (
        <div
          className="mt-3 grid grid-cols-2 gap-0.5 h-[288px] border border-[color:var(--background-third)] rounded-2xl overflow-hidden">
    ...
    case 4:
      return (
        <div
          className="mt-3 grid grid-cols-2 gap-0.5 h-[286px] border border-[color:var(--background-third)] rounded-2xl overflow-hidden">
