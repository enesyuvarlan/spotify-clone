...
import Poll from "~/components/post/pool";
        ...
        <div>
          ...
          <div className="flex -ml-1.5 mt-1.5">
            ...
            <div className="flex-1 group flex items-center gap-px">
              ...
              <span
                className="text-[0.813rem] transition-colors text-[color:var(--color-base-secondary)] group-hover:text-[#f91880]">{numberFormat(post.stats.like)}
              </span>
            </div>
