  ...
  return (
    <Popover className="relative text-[color:var(--color-base)]">
      <Popover.Button className="py-[3px] group w-full text-left outline-none">
        <div
          className={"p-3 rounded-full transition-colors inline-flex items-center group-hover:bg-[color:var(--background-third)]"}>
      ...
      <Popover.Panel
        className="w-[318px] absolute rounded-xl bottom-0 left-0 bg-[color:var(--background-primary)] shadow-box overflow-hidden">
        <Link to="/">
          <button
            className="p-3 h-14 w-full transition-colors inline-flex items-center gap-5 hover:bg-[color:var(--background-secondary)]">
            <div className="w-[26.25px] h-[26.25px] relative">
