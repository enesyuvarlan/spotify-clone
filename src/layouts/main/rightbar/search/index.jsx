...
export function Search() {
  ...
  return (
    <div
      ref={ref}
      className="min-h-[32px] h-[53px] mb-3 flex items-center sticky top-0 bg-[#15202b] z-10"
    >
      <label
        className="group h-[43px] rounded-full bg-[#273340] w-full focus-within:bg-[#15202b] border border-transparent focus-within:border-[#1d9bf0] relative">
        <div className="w-[56px] h-full flex items-center justify-center absolute top-0 left-0 pointer-events-none">
          <svg viewBox="0 0 24 24" height={18.75} className="h-4 min-w-[32px] text-[#8b98a5]">
            <path
              fill="currentColor"
        ...
        <input className="w-full h-full bg-transparent rounded-full outline-none pl-[56px] text-[15px]"
               type="text"
               placeholder="Search"
               value={query}
        ...
        {(query && focus) && (
          <button
            ...
            onClick={() => setQuery('')}
          >
            <svg viewBox="0 0 15 15" width={10} height={10} className="">
              <path
                fill="currentColor"
