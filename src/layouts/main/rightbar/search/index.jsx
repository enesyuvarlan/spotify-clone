...
export function Search() {
  ...
  return (
    ...
    >
      <label
        className="group h-[2.688rem] rounded-full bg-[color:var(--background-third)] w-full focus-within:bg-[color:var(--background-primary)] border border-transparent focus-within:border-[color:var(--color-primary)] relative">
